...
$form.Size            = New-Object System.Drawing.Size(460, 476)
...
# Header - adicionado primeiro (Dock=Top empilha de baixo pra cima)
...
$footer.Location  = New-Object System.Drawing.Point(0, 386)
